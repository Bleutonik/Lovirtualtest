  ...
  return (
    <header className="sticky top-0 z-50 bg-[#111827] shadow-lg">
      <div className="flex items-center justify-between px-4 py-2">
        {/* Sección izquierda - Puntos y badges */}
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-gray-800 rounded-full px-3 py-1.5">
            ...
            <span className="text-white text-sm font-medium">0 pts</span>
          </div>

          {/* Badge de ranking */}
          <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-full px-2.5 py-1">
            <span className="text-white text-sm font-bold">#0</span>
          </div>

          {/* Iconos de tema y notificaciones */}
